...
@ 01,01 say "Maringa, " + Str( nDia ) + " do " + cMes + " de " + Str( nAno )
@ 03,01 say "Nome do Cliente: " + AllTrim( cCliente )
@ 04,01 say "Idade..........: " + Str( nIdade )
@ 05,01 say "Endere‡o.......: " + AllTrim( cEndereco )
