...
//falta
//busque espaáo na tela para o recurso de conselho

//use a validaá∆o para o esc ap¢s cada read
clear
...
do while .t.
   ...
   @ 02,01 say 'Endereáo: Rua dos bobos - N¯ 0'
   ...
   @ 13,17 say '1¯ BIMESTRE'
   @ 13,29 say '2¯ BIMESTRE'
   @ 13,41 say '3¯ BIMESTRE'
   @ 13,53 say '4¯ BIMESTRE'
   ...
   //fazer laáo de repetiá∆o para o registro de cada disciplina (poss°vel)
   //DISCIPLINA 1
   @ 16,01 get cDisciplina1
   @ 16,17 get nNota1    picture cMascaraNota     valid nNota1 <= 10
   @ 16,22 get nFaltas1  picture cMascaraFaltas
   @ 16,29 get nNota2    picture cMascaraNota     valid nNota2 <= 10
   @ 16,34 get nFaltas2  picture cMascaraFaltas
   @ 16,41 get nNota3    picture cMascaraNota     valid nNota3 <= 10
   @ 16,46 get nFaltas3  picture cMascaraFaltas
   @ 16,53 get nNota4    picture cMascaraNota     valid nNota4 <= 10
   ...
   //-----------------------------------------------------------------------------
   //DISCIPLINA2 (AJUSTAR TRECHO ATê A DISCIPLINA 4)
   ...
   if nMedia2 < 6 .or. nTotalFaltas2 > 56
      ...
      cCor       := 'R/B'
      cResultado := 'REP'
   elseif nMedia2 >= 6 .and. ( nTotalFaltas2 <= 56 .and. nTotalFaltas2 > 48 )
      cCor       := 'G/B'
   ...
   if nMedia3 < 6 .or. nTotalFaltas3 > 56
      ...
      cCor       := 'R/B'
      cResultado := 'REP'
   elseif nMedia3 >= 6 .and. ( nTotalFaltas3 <= 56 .and. nTotalFaltas3 > 48 )
      cCor       := 'G/B'
   ...
   if nMedia4 < 6 .or. nTotalFaltas4 > 56
      ...
      cCor       := 'R/B'
      cResultado := 'REP'
   elseif nMedia4 >= 6 .and. ( nTotalFaltas4 <= 56 .and. nTotalFaltas4 > 48 )
      cCor       := 'G/B'
  ...
  /* if nMedia4 < 6 .or. nTotalFaltas4 > 56
   ...
   if ( nReprova > 2 .and. cBolsista = 'N' ) .or. ( cBolsista = 'I' .and. nReprova > 0 ) .or. ( cBolsista = 'P' .and. nReprova > 1 )
      cResposta    := 'Reprovado na(s) seguinte(s) disciplina(s):'
   elseif ( nReprova <= 2 .and. cBolsista = 'N' ) .or. ( cBolsista = 'P' .and. nReprova = 1 )
